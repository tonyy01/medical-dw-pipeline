...
SELECT
    ...
    round(avg(dc.encounter_duration_minutes / 1440.0)::numeric, 2) AS avg_los_days,
    round(avg(dc.total_claim_cost)::numeric, 2) AS avg_total_cost,
    round((percentile_cont(0.5) WITHIN GROUP (ORDER BY dc.total_claim_cost))::numeric, 2) AS median_total_cost,
